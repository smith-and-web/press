...
Portable design-system source · **0.14.0** · `@kindling/design-system`
...
This creates `kindling-design-system-0.14.0.tgz`. Put the archive inside your consumer repository, for example `vendor/`, then run from that repository:

```sh
npm install --save-exact ./vendor/kindling-design-system-0.14.0.tgz
```
